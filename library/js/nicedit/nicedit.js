...
var nicTableOptions = {
  buttons : {
    'table' : {name : 'Table', type : 'nicTableButton'}
  },
  iconFiles: {
    'table': RAZOR_BASE_URL + 'library/images/nicEditorTableIcon.gif'
  }
};
...
var nicTableButton = nicEditorAdvancedButton.extend({
  ...
  submit: function (e) {
    ...
    var TableCode = '<table class="table table-bordered table-striped table-condensed" width="'+ width +'"><thead><tr>';
